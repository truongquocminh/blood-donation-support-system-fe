...
export const REMINDER_TYPE_COLORS = {
  [REMINDER_TYPE.BLOOD_DONATION]: "bg-red-100 text-red-800",
  [REMINDER_TYPE.APPOINTMENT]: "bg-blue-100 text-blue-800",
  [REMINDER_TYPE.HEALTH_CHECK]: "bg-green-100 text-green-800",
};

export const REMINDER_TYPE_LABELS = {
  [REMINDER_TYPE.BLOOD_DONATION]: "Hiến máu",
  [REMINDER_TYPE.APPOINTMENT]: "Cuộc hẹn",
  [REMINDER_TYPE.HEALTH_CHECK]: "Kiểm tra sức khỏe",
};
