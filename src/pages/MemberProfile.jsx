...
import { FaUser, FaEnvelope, FaPhone, FaMapMarkerAlt, FaTint, FaCalendar } from 'react-icons/fa';
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        <InfoItem icon={FaEnvelope} label="Email" value={member.email} />
        <InfoItem icon={FaPhone} label="Phone" value={member.phone} />
        <InfoItem icon={FaMapMarkerAlt} label="Address" value={member.address} />
        <InfoItem icon={FaCalendar} label="Date of Birth" value={member.dateOfBirth} />
        <InfoItem icon={FaTint} label="Total Donations" value={member.totalDonations} />
        <InfoItem icon={FaCalendar} label="Next Eligible Date" value={member.nextEligibleDate} />
      </div>
